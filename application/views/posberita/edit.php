            ...
            <form action="" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    <div class="col-lg-10">
                        ...
                        <input type="text" class="form-control" id="judul" name="judul" value="<?= $editberita['judul']; ?>">
                        ...
                        <select name="kategori" id="kategori" class="form-control">
                            ...
                            <?php foreach ($kategori as $k) : ?>
                                <?php if ($k == $kategori['kategori']) : ?>
                                    <option value="<?php echo $k['kategori']; ?>" selected><?php echo $k['kategori']; ?></option>
                                    <?php else : ?>
                ...
                <div class="form-group">
                    <div class="col-lg-12">
                        ...
                        <textarea name="berita" class="ckeditor" id="berita" <?= $editberita['berita']; ?>></textarea>
                ...
                <div class="form-group">
                    <div class="col-lg-5">
                        ...
                        <input type="text" class="form-control" id="keyword" name="keyword" <?= $editberita['keyword']; ?>>
